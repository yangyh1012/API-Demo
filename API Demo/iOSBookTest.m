...
- (void)iOS6ProgrammingCookbook {
     ...
     *
     ...
     1.7. 在后台处理网络连接
     （未看）第16 章 日期，日程表和事件
     （未看，旧方法）1.14. 动画之视图的移动
     （未看，旧方法）1.15. 动画之视图的缩放
     （未看，旧方法）1.16. 动画之视图的旋转
     （未看）第19 章 iCloud
     （未看）第20 章 Pass Kit
     */
    ...
    /*
     第19 章 iCloud
        1.1. 为你的APP 使用iCloud 做相关配置
        1.2. 在iCloud 中对字典进行存储和同步
        1.3. 对iCloud 中的文件和文件夹进行创建和管理
        1.4. 查找iCloud 中的文件和文件夹
        1.5. 将用户的Document 存储到iCloud 中
        1.6. 管理iCloud 中文档的状态
        1.7. 处理iCloud 中文档的冲突
     */
    ...
    /*
     第20 章 Pass Kit
        ...
        1.5. 对通行证进行数字签名
        1.6. 通过Email 分发通行证
        1.7. 通过Web Services 分发通行证
        1.8. 使你的程序可以访问iOS 设备中的Pass
        1.9. 通过编程与Passbook 进行交互
     */
}
